...
bool TinyGPS::term_complete()
{
  ...
  if (_term_number == 0)
  {
    ...
    else if (!gpsstrcmp(_term, _PUBX_TERM))      // Kevin
      _sentence_type = _GPS_SENTENCE_PUBX;       // Kevin
    else
      _sentence_type = _GPS_SENTENCE_OTHER;
    return false;
  }
    ...
    switch(COMBINE(_sentence_type, _term_number))
  {
    ...
    case COMBINE(_GPS_SENTENCE_PUBX, 2): //Kevin
    ...
    case COMBINE(_GPS_SENTENCE_PUBX, 3): //Kevin
      _new_latitude = parse_degrees();
      _new_position_fix = millis();
      break;
    case COMBINE(_GPS_SENTENCE_GPRMC, 4): // N/S
    case COMBINE(_GPS_SENTENCE_GPGGA, 3):
    case COMBINE(_GPS_SENTENCE_PUBX, 4): //Kevin
      if (_term[0] == 'S')
        _new_latitude = -_new_latitude;
      break;
    case COMBINE(_GPS_SENTENCE_GPRMC, 5): // Longitude
    case COMBINE(_GPS_SENTENCE_GPGGA, 4):
    case COMBINE(_GPS_SENTENCE_PUBX, 5): //Kevin
      _new_longitude = parse_degrees();
      break;
    case COMBINE(_GPS_SENTENCE_GPRMC, 6): // E/W
    case COMBINE(_GPS_SENTENCE_GPGGA, 5):
    case COMBINE(_GPS_SENTENCE_PUBX, 6): //Kevin
      if (_term[0] == 'W')
        _new_longitude = -_new_longitude;
      break;
    case COMBINE(_GPS_SENTENCE_GPRMC, 7): // Speed (GPRMC)
    case COMBINE(_GPS_SENTENCE_PUBX, 11): //Kevin
      _new_speed = parse_decimal();
      break;
    case COMBINE(_GPS_SENTENCE_GPRMC, 8): // Course (GPRMC)
    case COMBINE(_GPS_SENTENCE_PUBX, 12): //Kevin
      _new_course = parse_decimal();
      break;
    case COMBINE(_GPS_SENTENCE_GPRMC, 9): // Date (GPRMC)
      _new_date = gpsatol(_term);
      break;
    case COMBINE(_GPS_SENTENCE_GPGGA, 6): // Fix data (GPGGA, 0=Inval, 1=GPSfix, 2=DGPSfix)
      _gps_data_good = _term[0] > '0';
      break;
    case COMBINE(_GPS_SENTENCE_GPGGA, 7): // Satellites used (GPGGA)
    case COMBINE(_GPS_SENTENCE_PUBX, 18): //Kevin
      _new_numsats = (unsigned char)atoi(_term);
      break;
    case COMBINE(_GPS_SENTENCE_GPGGA, 8): // HDOP
    case COMBINE(_GPS_SENTENCE_PUBX, 15): //Kevin
      _new_hdop = parse_decimal();
      break;
    case COMBINE(_GPS_SENTENCE_GPGGA, 9): // Altitude (GPGGA)
    case COMBINE(_GPS_SENTENCE_PUBX, 7): //Kevin
      _new_altitude = parse_decimal();
      break;
    case COMBINE(_GPS_SENTENCE_PUBX, 8): //Kevin, Navigation Status
      _gps_data_good = _term[0] != 'N';  //Not equal to NF, (this is the only response that starts with an N)
      break;
